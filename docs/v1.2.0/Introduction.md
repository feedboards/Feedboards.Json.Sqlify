...
- [Error Codes](https://github.com/feedboards/Feedboards.Json.Sqlify/tree/dev/docs/v1.2.0/clickhouse/error_codes.md) - Detailed list of error codes and their meanings
...
- [Error Codes Documentation](https://github.com/feedboards/Feedboards.Json.Sqlify/tree/dev/docs/v1.2.0/clickhouse/error_codes.md)
...
1. Check the [documentation](https://github.com/feedboards/Feedboards.Json.Sqlify/tree/dev/docs/v1.2.0)
